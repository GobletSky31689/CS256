In this trial, the number of features are considered to be the base case or say normal as the network description was provided as example in the howmework description file  network description file,
the network architechture is the text file is shown like below in the network_desc.txt file:
...
Total number of Epoch used to reach minimum validation cost: 11
Testing Accuracy Achieved: 92.400002%
