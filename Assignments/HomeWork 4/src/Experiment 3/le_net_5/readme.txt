In this trial, the number of features are considered according to LeNet, the network architechture is the text file is shown like below in the le_net_5.txt file:
...
Total number of Epoch used to reach minimum validation cost: 30
